#!/usr/bin/env python
"""Deploy momentum strategy: run screener and rebalance to 33-stock portfolio (AUTO-EXECUTE)."""
import sys
import time
sys.path.insert(0, '.')
...
print("=" * 80)
print("DEPLOYING MOMENTUM STRATEGY - 33 STOCK PORTFOLIO (AUTO-EXECUTE)")
print("=" * 80)
...
try:
    ...
    ib = IB()
    ib.connect('127.0.0.1', 4001, clientId=5, timeout=10)
    print("✓ Connected")
    ...
    # Execute rebalance (AUTO - NO PROMPT)
    print("\n" + "=" * 80)
    print("EXECUTING REBALANCE (AUTO-MODE)")
    print("=" * 80)
    ...
    print("\nWaiting for orders to settle (20 seconds)...")
    time.sleep(20)
